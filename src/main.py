...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Customizable Image Retrieval Framework")
    parser.add_argument("--config", type=str, required=True, help="Path to config file")
    parser.add_argument("--pipeline", type=str, required=True, help="Pipeline to run: train, test, inference")
